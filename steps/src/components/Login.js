    ...
    async function handleSubmit(values) {
        ...
        AuthService.login(values.email, values.password).then(
            ...
            error => {
                ...
                initialValues.message = resMessage;
                        ...
                        {({handleSubmit}) => (
                            <Form>
                                ...
                                <div>
                                    ...
                                    <Field className="input" type="password" id="password"
                                           name="password"/>
