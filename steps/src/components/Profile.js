...
const Profile = () => {
    ...
    useEffect(() => {
        ...
        axios
            .get(`http://localhost:3000/circuits/`)
            .then((response) => {
    ...
    const deleteCircuit = (id_circuit) => {
        if (favSelected === false){
            axios
                .delete(`http://localhost:3000/circuits/${id_circuit}`)

                .then(res => {
                    console.log(res);
                    console.log(res.data);
                    const routes = selectedTabArray.filter(item => item._id !== id_circuit);
                    setSelectedTabArray(
                        (function () {
                            return routes
                        })
            ...
            <div>
                ...
                <div>
                    ...
                    >
                        ...
                        {/*TODO substituir por user.avatar*/}
                        <img
                    ...
                    {selectedTabArray.map((props) => (
                        <div className="profileCard" key={props._id} id={props._id}>
                            <section className="cardButton">
                                ...
                                <section>
                                    <button
                                        className="profileButton" onClick={() => editCircuit(props._id)}
                                    ...
                                    <button className="profileButton" onClick={() => deleteCircuit(props._id)}>
                                        <svg
                                            style={{display: "flex", margin: "auto"}}
                                            width="16"
                                            height="15"
                            ...
                            <section className="sideButton">
                                <Link to={"/main"} state={{id: props._id}}>
