    ...
    return(
        <div style={theme}>
                ...
                <div style={{
                    ...
                    <section style={{width: '100%', marginLeft: '2.5rem', marginRight: '2.5rem', paddingBottom: '1.5rem'}}>
                        ...
                        <div style={{marginTop: '3rem'}}>
                            <button style={{width: '100%', border: 'none', borderRadius: 50, background: '#393C6A', color: 'white', fontSize: 17, height: '3rem'}} type="submit">Entrar</button>
                        </div>

                        <div style={{marginTop: '1rem'}}>
                            <p style={{fontSize: 12, textDecoration: 'underline', textAlign: 'center'}}>Esqueceste-te da password?</p>
                        </div>
                        ...
                        <div style={{marginTop: '3rem'}}>
                            <button style={{width: '100%', border: 'none', borderRadius: 50, background: 'linear-gradient(90deg, #FCE0BA 15%, #F4B59D 90%)', color: 'white', height: '3rem', fontSize: 16}} type="submit">Entrar sem conta</button>
                        </div>

                        <div style={{marginTop: '1rem'}}>
                            <Link to={'/register'}>
                                <p style={{fontSize: 13, textDecoration: 'underline', textAlign: 'center'}}>Regista-te aqui!</p>
                            </Link>
                        </div>
